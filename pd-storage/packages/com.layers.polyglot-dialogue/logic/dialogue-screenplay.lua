--------------------------------------------------------------------------------
--  Logic-script..... : dialogue-screenplay
--  Author........... :
--  Description...... :
--------------------------------------------------------------------------------
...
function  main()
--------------------------------------------------------------------------------
    log.message( "Running: " .. "dialogue-screenplay" )
    ...
    then
        ...
        local sTargetFile = system.getFileDirectory ( project.getFilePath ( hFileToCopy ) ) .. project.getFileName ( hFileToCopy ) .. ".pds"
